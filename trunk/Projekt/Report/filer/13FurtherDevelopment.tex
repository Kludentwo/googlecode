...
The measurement system will also have to be improved. Either through a redesign or implementation of a know system with low power consumption and low noise.\fxfatal{Skal omskrives med en mere positiv tone og tilføj calibration}.
