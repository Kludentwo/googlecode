...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=1\textwidth]{billeder/11ProjectDescription/detailedCDU}
...
\fixme{Skriv mere til SN}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=1\textwidth]{billeder/11ProjectDescription/SN_detailed_design}
