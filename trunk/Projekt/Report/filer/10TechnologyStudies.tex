...
The I$^2$C protocol is a two wire system with multiple slaves, which responds to requests from the master. An I$^2$C transfer sequence is seen on the figure \ref{fig:i2cheader}. The figure originates from the I$^2$C protocol specification \fixme{reference til i2c protocol specificationen på http://i2c.info/i2c-bus-specification}
\begin{figure}[H]
	\centering
...
\section{Outcome}
\fxfatal{sludder for en sladder om valg!}
