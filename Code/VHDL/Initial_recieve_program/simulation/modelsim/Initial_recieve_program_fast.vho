...
-- START_o[0]	=>  Location: PIN_M21,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- START_o[1]	=>  Location: PIN_N24,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- START_o[2]	=>  Location: PIN_L23,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- START_o[3]	=>  Location: PIN_M24,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- START_o[4]	=>  Location: PIN_N23,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- START_o[5]	=>  Location: PIN_M19,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- START_o[6]	=>  Location: PIN_M25,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- START_o[7]	=>  Location: PIN_M20,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- ADDR_o[0]	=>  Location: PIN_L25,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- ADDR_o[1]	=>  Location: PIN_N20,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- ADDR_o[2]	=>  Location: PIN_M22,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- ADDR_o[3]	=>  Location: PIN_M23,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- current_state[0]	=>  Location: PIN_L24,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- current_state[1]	=>  Location: PIN_L19,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- current_state[2]	=>  Location: PIN_P24,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- current_state[3]	=>  Location: PIN_Y3,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- Equation(s):
-- \state~10_combout\ = (\r3~regout\) # ((\r4~regout\) # (\r2~regout\ $ (!\r1~regout\)))
...
-- Equation(s):
-- \Add0~0_combout\ = address_counter(2) $ (((\bit_count~regout\ & (address_counter(0) & address_counter(1)))))
...
-- Equation(s):
-- \Selector9~0_combout\ = (\Add0~0_combout\ & ((\state.address_check~regout\) # ((\state.get_data~regout\ & address_counter(2))))) # (!\Add0~0_combout\ & (\state.get_data~regout\ & (address_counter(2))))
...
-- Equation(s):
-- \Selector10~0_combout\ = (\state.address_check~regout\ & (address_counter(1) $ (((\bit_count~regout\ & address_counter(0))))))
...
-- Equation(s):
-- \state~8_combout\ = (!\LEDS[0]~1_combout\ & (((address_counter(1)) # (address_counter(0))) # (!address_counter(2))))
...
-- Equation(s):
-- \Selector4~0_combout\ = (\state.address_check~regout\) # (\s3~regout\)
...
-- Equation(s):
-- \Selector0~0_combout\ = (\state.address_check~regout\) # (\s7~regout\)
...
-- Equation(s):
-- \Equal0~0_combout\ = (((\s3~regout\) # (\s2~regout\)) # (!\s4~regout\)) # (!\s1~regout\)
...
-- Equation(s):
-- \state~16_combout\ = (\state~8_combout\ & (((\state.idle~regout\) # (!\state~15_combout\)) # (!\state~10_combout\)))
...
-- Equation(s):
-- \Selector13~0_combout\ = (\r3~regout\) # (\state.get_data~regout\)
...
-- Equation(s):
-- \state~9_combout\ = (!\r3~regout\ & (!\r4~regout\ & (\r2~regout\ $ (\r1~regout\))))
...
-- Equation(s):
-- \Selector14~0_combout\ = (\r2~regout\) # (\state.get_data~regout\)
