...
SIGNAL \inst7|communication:Respond_Data[17]~0_combout\ : std_logic;
...
SIGNAL \inst7|Selector4~7_combout\ : std_logic;
SIGNAL \inst7|Selector4~4_combout\ : std_logic;
SIGNAL \inst7|Selector4~6_combout\ : std_logic;
...
SIGNAL \inst7|communication:Respond_Data[17]~1_combout\ : std_logic;
...
SIGNAL \inst1|data_counter[3]~5_combout\ : std_logic;
...
SIGNAL \inst7|flopped_ADC_DATA[9]~feeder_combout\ : std_logic;
...
SIGNAL \inst7|flopped_ADC_DATA[2]~feeder_combout\ : std_logic;
...
SIGNAL \inst7|flopped_ADC_DATA[4]~feeder_combout\ : std_logic;
...
SIGNAL \inst7|flopped_ADC_DATA[6]~feeder_combout\ : std_logic;
...
SIGNAL \inst7|flopped_ADC_DATA[7]~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \inst1|Add0~4_combout\ = (\inst1|Add0~3\ & (\inst1|wait_counter\(2) & (\Reset_ADC_comm~combout\ & VCC))) # (!\inst1|Add0~3\ & ((((\inst1|wait_counter\(2) & \Reset_ADC_comm~combout\)))))
-- \inst1|Add0~5\ = CARRY((\inst1|wait_counter\(2) & (\Reset_ADC_comm~combout\ & !\inst1|Add0~3\)))
...
-- Equation(s):
-- \inst1|Add0~8_combout\ = (\inst1|Add0~7\ & (\inst1|wait_counter\(4) & (\Reset_ADC_comm~combout\ & VCC))) # (!\inst1|Add0~7\ & ((((\inst1|wait_counter\(4) & \Reset_ADC_comm~combout\)))))
-- \inst1|Add0~9\ = CARRY((\inst1|wait_counter\(4) & (\Reset_ADC_comm~combout\ & !\inst1|Add0~7\)))
...
PORT MAP (
	...
	sload => VCC,
	ena => \inst7|communication:Respond_Data[17]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- ((\inst7|communication:respond_counter[4]~regout\) # (\inst7|Selector30~0_combout\)))))
...
-- Equation(s):
-- \inst1|data_counter~3_combout\ = (\Reset_ADC_comm~combout\ & \inst1|data_counter\(2))
...
-- Equation(s):
-- \inst7|errors~0_combout\ = (\inst7|communication:fault~regout\) # (\inst7|communication:errors[0]~regout\)
...
PORT MAP (
	...
	datad => \inst7|communication:errors[0]~regout\,
	combout => \inst7|errors~0_combout\);

-- Location: LCCOMB_X63_Y20_N2
\inst7|Selector4~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|Selector4~2_combout\ = (\inst7|r_state.check_functioncode~regout\) # ((\inst7|r_state.check_address~regout\ & ((!\inst7|communication:address_counter[2]~regout\))) # (!\inst7|r_state.check_address~regout\ & 
...
-- Equation(s):
-- \inst1|wait_counter~3_combout\ = (!\inst1|LessThan0~3_combout\ & \inst1|Add0~14_combout\)
...
-- Equation(s):
-- \inst1|wait_counter~6_combout\ = (!\inst1|LessThan0~3_combout\ & \inst1|Add0~6_combout\)
...
-- Equation(s):
-- \inst7|errors~1_combout\ = (\inst7|communication:Respond_Data[17]~0_combout\ & (!\inst7|Selector3~2_combout\ & ((\inst7|communication:errors[0]~regout\) # (\inst7|communication:fault~regout\)))) # (!\inst7|communication:Respond_Data[17]~0_combout\ & 
-- (((\inst7|communication:errors[0]~regout\) # (\inst7|communication:fault~regout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst7|communication:Respond_Data[17]~0_combout\,
...
PORT MAP (
	...
	datad => \inst1|Decoder0~46_combout\,
...
-- Equation(s):
-- \inst1|Decoder0~43_combout\ = (\inst1|Decoder0~45_combout\ & (\inst1|Decoder0~38_combout\ & ((!\Reset_ADC_comm~combout\) # (!\inst1|data_counter\(3)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst1|Decoder0~45_combout\,
...
-- Equation(s):
-- \inst1|Decoder0~45_combout\ = (\Reset_ADC_comm~combout\ & (!\inst1|data_counter\(2) & (\inst1|wait_conv~regout\ & \inst1|Decoder0~36_combout\)))
...
PORT MAP (
	...
	datad => \inst1|Decoder0~36_combout\,
...
-- Equation(s):
-- \inst7|manchester_bit~0_combout\ = (\inst7|communication:m1~regout\ & ((\inst7|communication:manchester_bit~regout\) # (!\DIN~combout\))) # (!\inst7|communication:m1~regout\ & (\inst7|communication:manchester_bit~regout\ & !\DIN~combout\))
...
-- Equation(s):
-- \inst7|Selector14~1_combout\ = (\inst7|Selector14~0_combout\) # ((\inst7|communication:fault~regout\ & ((\inst7|f_state.manchester_converting~regout\) # (\inst7|f_state.respond~regout\))))
...
PORT MAP (
	dataa => \inst7|f_state.manchester_converting~regout\,
	datab => \inst7|Selector14~0_combout\,
	datac => \inst7|communication:fault~regout\,
	datad => \inst7|f_state.respond~regout\,
...
-- Equation(s):
-- \inst7|Add0~0_combout\ = \inst7|communication:address_counter[2]~regout\ $ (((\inst7|communication:address_counter[1]~regout\ & \inst7|communication:address_counter[0]~regout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst7|communication:address_counter[1]~regout\,
	datab => \inst7|communication:address_counter[2]~regout\,
	datac => \inst7|communication:address_counter[0]~regout\,
...
-- Equation(s):
-- \inst7|Selector23~0_combout\ = (\inst7|f_state.respond~regout\) # ((\inst7|f_state.manchester_converting~regout\ & ((!\inst7|manchester_counter~regout\) # (!\inst7|r_state.check_address~regout\))))
...
-- Equation(s):
-- \inst7|Selector19~0_combout\ = (\inst7|Selector22~0_combout\ & ((\inst7|Add0~0_combout\) # ((\inst7|communication:address_counter[2]~regout\ & \inst7|Selector23~0_combout\)))) # (!\inst7|Selector22~0_combout\ & 
-- (((\inst7|communication:address_counter[2]~regout\ & \inst7|Selector23~0_combout\))))
...
-- Equation(s):
-- \inst7|Selector2~1_combout\ = (\inst7|r_state.check_address~regout\ & (\inst7|communication:address_counter[2]~regout\ & (!\inst7|communication:address_counter[0]~regout\ & !\inst7|communication:address_counter[1]~regout\)))
...
PORT MAP (
	...
	datab => \inst7|communication:address_counter[2]~regout\,
	datac => \inst7|communication:address_counter[0]~regout\,
	datad => \inst7|communication:address_counter[1]~regout\,
	combout => \inst7|Selector2~1_combout\);

-- Location: LCCOMB_X63_Y20_N24
\inst7|Selector2~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|Selector2~2_combout\ = (!\inst7|Selector3~2_combout\ & ((\inst7|Selector2~1_combout\ & (\inst7|Equal2~0_combout\)) # (!\inst7|Selector2~1_combout\ & ((\inst7|Selector2~0_combout\)))))
...
PORT MAP (
	...
	datad => \inst7|Selector2~1_combout\,
...
-- Equation(s):
-- \inst7|Selector17~0_combout\ = (\inst7|manchester_counter~regout\ & (\inst7|r_state.check_functioncode~regout\ & \inst7|f_state.manchester_converting~regout\))
...
-- Equation(s):
-- \inst7|Selector29~0_combout\ = (\inst7|Selector16~0_combout\ & ((\inst7|m_f_bit1~regout\) # ((\inst7|manchester_bit~0_combout\ & \inst7|Selector17~0_combout\)))) # (!\inst7|Selector16~0_combout\ & (\inst7|manchester_bit~0_combout\ & 
...
-- Equation(s):
-- \inst7|Selector28~0_combout\ = (\inst7|Selector16~0_combout\ & ((\inst7|m_f_bit2~regout\) # ((\inst7|m_f_bit1~regout\ & \inst7|Selector17~0_combout\)))) # (!\inst7|Selector16~0_combout\ & (\inst7|m_f_bit1~regout\ & ((\inst7|Selector17~0_combout\))))
...
-- Equation(s):
-- \inst7|Selector27~0_combout\ = (\inst7|Selector16~0_combout\ & ((\inst7|m_f_bit3~regout\) # ((\inst7|m_f_bit2~regout\ & \inst7|Selector17~0_combout\)))) # (!\inst7|Selector16~0_combout\ & (\inst7|m_f_bit2~regout\ & ((\inst7|Selector17~0_combout\))))
...
-- Equation(s):
-- \inst7|Selector26~0_combout\ = (\inst7|Selector16~0_combout\ & ((\inst7|m_f_bit4~regout\) # ((\inst7|m_f_bit3~regout\ & \inst7|Selector17~0_combout\)))) # (!\inst7|Selector16~0_combout\ & (\inst7|m_f_bit3~regout\ & ((\inst7|Selector17~0_combout\))))
...
\inst7|communication:Respond_Data[17]~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|communication:Respond_Data[17]~0_combout\ = (!\inst7|m_f_bit3~regout\ & (!\inst7|m_f_bit4~regout\ & (\inst7|m_f_bit2~regout\ $ (\inst7|m_f_bit1~regout\))))
...
PORT MAP (
	...
	combout => \inst7|communication:Respond_Data[17]~0_combout\);

-- Location: LCCOMB_X63_Y21_N12
\inst7|Equal8~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|Equal8~0_combout\ = (\inst7|communication:respond_counter[1]~regout\ & (\inst7|communication:respond_counter[0]~regout\ & (\inst7|communication:respond_counter[2]~regout\ & !\inst7|communication:respond_counter[3]~regout\)))
...
-- Equation(s):
-- \inst7|respond_counter~1_combout\ = (!\inst7|Equal8~0_combout\ & (\inst7|communication:respond_counter[4]~regout\ $ (((\inst7|communication:respond_counter[3]~regout\ & \inst7|Add3~0_combout\)))))
...
-- Equation(s):
-- \inst7|Equal8~1_combout\ = (\inst7|Equal8~0_combout\ & (\inst7|communication:respond_counter[4]~regout\ $ (((\inst7|communication:respond_counter[3]~regout\ & \inst7|Add3~0_combout\)))))
...
-- Equation(s):
-- \inst7|Selector3~5_combout\ = (\inst7|communication:respond_flag~regout\) # ((!\inst7|Equal2~0_combout\ & \inst7|Selector2~1_combout\))
...
-- Equation(s):
-- \inst7|Selector3~3_combout\ = (\Reset_comm~combout\ & (!\inst7|communication:fault~regout\ & ((\inst7|Equal2~0_combout\) # (!\inst7|Selector2~1_combout\))))
...
PORT MAP (
	...
	datab => \inst7|Selector3~4_combout\,
...
-- Equation(s):
-- \inst7|Selector3~7_combout\ = (\inst7|Selector3~2_combout\ & (\inst7|communication:Respond_Data[17]~0_combout\)) # (!\inst7|Selector3~2_combout\ & ((\inst7|Selector3~6_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst7|Selector3~2_combout\,
	datab => \inst7|communication:Respond_Data[17]~0_combout\,
...
-- Equation(s):
-- \inst7|Selector13~0_combout\ = (\DIN~combout\ & (((\inst7|start_bit1~regout\ & \inst7|f_state.respond~regout\)) # (!\inst7|f_state.idle~regout\))) # (!\DIN~combout\ & (((\inst7|start_bit1~regout\ & \inst7|f_state.respond~regout\))))
...
-- Equation(s):
-- \inst7|Selector11~0_combout\ = (\inst7|start_bit2~regout\ & (((\inst7|start_bit3~regout\ & \inst7|f_state.respond~regout\)) # (!\inst7|f_state.idle~regout\))) # (!\inst7|start_bit2~regout\ & (((\inst7|start_bit3~regout\ & 
...
-- Equation(s):
-- \inst7|Selector10~0_combout\ = (\inst7|f_state.respond~regout\ & ((\inst7|start_bit4~regout\) # ((!\inst7|f_state.idle~regout\ & \inst7|start_bit3~regout\)))) # (!\inst7|f_state.respond~regout\ & (!\inst7|f_state.idle~regout\ & 
-- ((\inst7|start_bit3~regout\))))
...
-- Equation(s):
-- \inst7|Selector9~0_combout\ = (\inst7|f_state.respond~regout\ & ((\inst7|start_bit5~regout\) # ((!\inst7|f_state.idle~regout\ & \inst7|start_bit4~regout\)))) # (!\inst7|f_state.respond~regout\ & (!\inst7|f_state.idle~regout\ & 
-- ((\inst7|start_bit4~regout\))))
...
-- Equation(s):
-- \inst7|Selector7~0_combout\ = (\inst7|f_state.respond~regout\ & ((\inst7|start_bit7~regout\) # ((!\inst7|f_state.idle~regout\ & \inst7|start_bit6~regout\)))) # (!\inst7|f_state.respond~regout\ & (!\inst7|f_state.idle~regout\ & 
-- ((\inst7|start_bit6~regout\))))
...
-- Equation(s):
-- \inst7|Selector6~0_combout\ = (\inst7|f_state.idle~regout\ & (((\inst7|start_bit8~regout\ & \inst7|f_state.respond~regout\)))) # (!\inst7|f_state.idle~regout\ & ((\inst7|start_bit7~regout\) # ((\inst7|start_bit8~regout\ & 
-- \inst7|f_state.respond~regout\))))
...
-- Equation(s):
-- \inst7|Equal0~1_combout\ = (((\inst7|start_bit8~regout\) # (!\inst7|start_bit7~regout\)) # (!\inst7|start_bit1~regout\)) # (!\inst7|start_bit6~regout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \inst7|start_bit6~regout\,
	datab => \inst7|start_bit1~regout\,
	datac => \inst7|start_bit7~regout\,
	datad => \inst7|start_bit8~regout\,
	combout => \inst7|Equal0~1_combout\);

-- Location: LCCOMB_X64_Y20_N12
\inst7|Equal0~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|Equal0~0_combout\ = (\inst7|start_bit2~regout\) # (((\inst7|start_bit5~regout\) # (\inst7|start_bit3~regout\)) # (!\inst7|start_bit4~regout\))
...
-- Equation(s):
-- \inst7|Selector1~2_combout\ = (!\inst7|r_state.idle~regout\ & (!\inst7|Equal0~1_combout\ & !\inst7|Equal0~0_combout\))
...
-- Equation(s):
-- \inst7|Selector1~5_combout\ = (\inst7|Selector1~2_combout\) # ((\Reset_comm~combout\ & (!\inst7|communication:fault~regout\ & \inst7|Selector1~4_combout\)))
...
PORT MAP (
	dataa => \Reset_comm~combout\,
	datab => \inst7|communication:fault~regout\,
	datac => \inst7|Selector1~2_combout\,
	datad => \inst7|Selector1~4_combout\,
...
-- Equation(s):
-- \inst7|Selector25~0_combout\ = (\inst7|Selector23~0_combout\ & ((\inst7|m_a_bit1~regout\) # ((\inst7|manchester_bit~0_combout\ & \inst7|Selector22~0_combout\)))) # (!\inst7|Selector23~0_combout\ & (\inst7|manchester_bit~0_combout\ & 
-- ((\inst7|Selector22~0_combout\))))
...
-- Equation(s):
-- \inst7|Selector24~0_combout\ = (\inst7|Selector23~0_combout\ & ((\inst7|m_a_bit2~regout\) # ((\inst7|m_a_bit1~regout\ & \inst7|Selector22~0_combout\)))) # (!\inst7|Selector23~0_combout\ & (\inst7|m_a_bit1~regout\ & ((\inst7|Selector22~0_combout\))))
...
-- Equation(s):
-- \inst7|Selector23~1_combout\ = (\inst7|Selector23~0_combout\ & ((\inst7|m_a_bit3~regout\) # ((\inst7|Selector22~0_combout\ & \inst7|m_a_bit2~regout\)))) # (!\inst7|Selector23~0_combout\ & (\inst7|Selector22~0_combout\ & ((\inst7|m_a_bit2~regout\))))
...
-- Equation(s):
-- \inst7|Equal2~0_combout\ = (!\inst7|m_a_bit3~regout\ & (\inst7|m_a_bit1~regout\ & (!\inst7|m_a_bit4~regout\ & !\inst7|m_a_bit2~regout\)))
...
-- Equation(s):
-- \inst7|Selector4~3_combout\ = (\inst7|r_state.check_address~regout\ & ((\inst7|communication:address_counter[0]~regout\) # ((\inst7|Equal2~0_combout\) # (\inst7|communication:address_counter[1]~regout\))))
...
-- Equation(s):
-- \inst7|Selector4~5_combout\ = ((\inst7|communication:functioncode_counter[0]~regout\) # ((\inst7|communication:functioncode_counter[1]~regout\) # (!\inst7|communication:functioncode_counter[2]~regout\))) # (!\inst7|r_state.check_functioncode~regout\)
...
\inst7|Selector4~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|Selector4~7_combout\ = (\inst7|f_state.manchester_converting~regout\ & (!\inst7|communication:fault~regout\ & (\Reset_comm~combout\ & \inst7|Selector4~5_combout\)))
...
PORT MAP (
	...
	datad => \inst7|Selector4~5_combout\,
	combout => \inst7|Selector4~7_combout\);

-- Location: LCCOMB_X63_Y20_N4
\inst7|Selector4~4\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|Selector4~4_combout\ = (!\inst7|r_state.check_functioncode~regout\ & (!\inst7|Equal0~1_combout\ & (!\inst7|Equal0~0_combout\ & !\inst7|r_state.check_address~regout\)))
...
\inst7|Selector4~6\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|Selector4~6_combout\ = (\inst7|Selector4~2_combout\ & (((\inst7|Selector4~7_combout\) # (\inst7|Selector4~4_combout\)))) # (!\inst7|Selector4~2_combout\ & (\inst7|Selector4~3_combout\ & (\inst7|Selector4~7_combout\)))
...
PORT MAP (
	...
	datab => \inst7|Selector4~3_combout\,
	datac => \inst7|Selector4~7_combout\,
	datad => \inst7|Selector4~4_combout\,
	combout => \inst7|Selector4~6_combout\);

-- Location: LCFF_X62_Y20_N13
\inst7|f_state.manchester_converting\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ALT_INV_Buffer_in~combout\,
	datain => \inst7|Selector4~6_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \inst7|Selector18~0_combout\ = (\inst7|f_state.manchester_converting~regout\ & (\inst7|communication:functioncode_counter[0]~regout\ $ (((\inst7|r_state.check_functioncode~regout\ & \inst7|manchester_counter~regout\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst7|communication:functioncode_counter[2]~regout\,
	datab => \inst7|communication:functioncode_counter[0]~regout\,
	datac => \inst7|communication:functioncode_counter[1]~regout\,
...
-- Equation(s):
-- \inst7|Selector16~1_combout\ = (\inst7|Selector16~0_combout\ & ((\inst7|communication:functioncode_counter[2]~regout\) # ((\inst7|Add1~0_combout\ & \inst7|Selector17~0_combout\)))) # (!\inst7|Selector16~0_combout\ & (\inst7|Add1~0_combout\ & 
-- ((\inst7|Selector17~0_combout\))))
...
-- Equation(s):
-- \inst7|Selector3~2_combout\ = (\inst7|r_state.check_functioncode~regout\ & (\inst7|communication:functioncode_counter[2]~regout\ & (!\inst7|communication:functioncode_counter[0]~regout\ & !\inst7|communication:functioncode_counter[1]~regout\)))
...
-- Equation(s):
-- \inst7|Selector1~3_combout\ = (\Reset_comm~combout\ & !\inst7|communication:fault~regout\)
...
-- Equation(s):
-- \inst7|Selector0~0_combout\ = (\inst7|r_state.idle~regout\ & (((!\inst7|Selector1~3_combout\)))) # (!\inst7|r_state.idle~regout\ & ((\inst7|Equal0~0_combout\) # ((\inst7|Equal0~1_combout\))))
...
-- Equation(s):
-- \inst7|Selector0~1_combout\ = (!\inst7|Selector3~2_combout\ & ((\inst7|Selector2~1_combout\ & (\inst7|Equal2~0_combout\)) # (!\inst7|Selector2~1_combout\ & ((!\inst7|Selector0~0_combout\)))))
...
-- Equation(s):
-- \inst7|Selector3~4_combout\ = (!\inst7|r_state.idle~regout\ & ((\inst7|communication:respond_flag~regout\) # ((!\inst7|Equal0~1_combout\ & !\inst7|Equal0~0_combout\))))
...
\inst7|communication:Respond_Data[17]~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|communication:Respond_Data[17]~1_combout\ = (\inst7|Selector3~2_combout\ & \inst7|communication:Respond_Data[17]~0_combout\)
...
PORT MAP (
	...
	datad => \inst7|communication:Respond_Data[17]~0_combout\,
	combout => \inst7|communication:Respond_Data[17]~1_combout\);
...
-- Equation(s):
-- \inst7|Selector5~1_combout\ = (\inst7|communication:Respond_Data[17]~1_combout\) # ((\inst7|Selector3~3_combout\ & (!\inst7|Selector3~4_combout\ & \inst7|Selector5~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst7|Selector3~3_combout\,
	datab => \inst7|Selector3~4_combout\,
	datac => \inst7|communication:Respond_Data[17]~1_combout\,
...
-- Equation(s):
-- \inst7|Add3~2_combout\ = \inst7|communication:respond_counter[2]~regout\ $ (((\inst7|communication:respond_counter[1]~regout\ & \inst7|communication:respond_counter[0]~regout\)))
...
-- Equation(s):
-- \inst7|Add3~0_combout\ = (\inst7|communication:respond_counter[1]~regout\ & (\inst7|communication:respond_counter[2]~regout\ & \inst7|communication:respond_counter[0]~regout\))
...
-- Equation(s):
-- \inst7|respond_counter~0_combout\ = (\inst7|Equal8~0_combout\ & (!\inst7|communication:respond_counter[4]~regout\ & (\inst7|Add3~0_combout\ $ (\inst7|communication:respond_counter[3]~regout\)))) # (!\inst7|Equal8~0_combout\ & (\inst7|Add3~0_combout\ $ 
...
-- Equation(s):
-- \inst1|Add0~0_combout\ = (((\inst1|wait_counter\(0) & \Reset_ADC_comm~combout\)))
-- \inst1|Add0~1\ = CARRY((\inst1|wait_counter\(0) & \Reset_ADC_comm~combout\))
...
-- Equation(s):
-- \inst1|Add0~2_combout\ = (\inst1|Add0~1\ & (((!\Reset_ADC_comm~combout\)) # (!\inst1|wait_counter\(1)))) # (!\inst1|Add0~1\ & (((\inst1|wait_counter\(1) & \Reset_ADC_comm~combout\)) # (GND)))
-- \inst1|Add0~3\ = CARRY(((!\inst1|Add0~1\) # (!\Reset_ADC_comm~combout\)) # (!\inst1|wait_counter\(1)))
...
-- Equation(s):
-- \inst1|Add0~6_combout\ = (\inst1|Add0~5\ & (((!\Reset_ADC_comm~combout\)) # (!\inst1|wait_counter\(3)))) # (!\inst1|Add0~5\ & (((\inst1|wait_counter\(3) & \Reset_ADC_comm~combout\)) # (GND)))
-- \inst1|Add0~7\ = CARRY(((!\inst1|Add0~5\) # (!\Reset_ADC_comm~combout\)) # (!\inst1|wait_counter\(3)))
...
-- Equation(s):
-- \inst1|Add0~12_combout\ = (\inst1|Add0~11\ & (\inst1|wait_counter\(6) & (\Reset_ADC_comm~combout\ & VCC))) # (!\inst1|Add0~11\ & ((((\inst1|wait_counter\(6) & \Reset_ADC_comm~combout\)))))
-- \inst1|Add0~13\ = CARRY((\inst1|wait_counter\(6) & (\Reset_ADC_comm~combout\ & !\inst1|Add0~11\)))
...
-- Equation(s):
-- \inst1|wait_conv~1_combout\ = (\inst1|wait_flag~regout\ & (!\inst1|done_flag~regout\)) # (!\inst1|wait_flag~regout\ & (((\Reset_ADC_comm~combout\ & \inst1|wait_conv~regout\))))
...
-- Equation(s):
-- \inst1|data_counter~11_combout\ = (\inst1|data_counter\(0) & ((\Reset_ADC_comm~combout\ & (\inst1|data_counter[3]~5_combout\)) # (!\Reset_ADC_comm~combout\ & ((\inst1|data_counter~4_combout\))))) # (!\inst1|data_counter\(0) & 
...
-- pragma translate_on
PORT MAP (
	dataa => \inst1|data_counter[3]~5_combout\,
	datab => \inst1|data_counter~4_combout\,
...
-- Equation(s):
-- \inst1|data_counter~7_combout\ = (\inst1|data_counter\(1) & \Reset_ADC_comm~combout\)
...
-- Equation(s):
-- \inst1|data_counter~9_combout\ = (\inst1|data_counter~7_combout\ & ((\inst1|data_counter[3]~5_combout\) # ((\inst1|data_counter~4_combout\ & !\inst1|data_counter~8_combout\)))) # (!\inst1|data_counter~7_combout\ & (((\inst1|data_counter~4_combout\ & 
-- \inst1|data_counter~8_combout\))))
...
PORT MAP (
	dataa => \inst1|data_counter[3]~5_combout\,
	datab => \inst1|data_counter~4_combout\,
	datac => \inst1|data_counter~8_combout\,
	datad => \inst1|data_counter~7_combout\,
...
-- Equation(s):
-- \inst1|done_flag~2_combout\ = (\Reset_ADC_comm~combout\ & (!\inst1|data_counter\(2) & (\inst1|data_counter\(0) & \inst1|data_counter\(1))))
...
PORT MAP (
	...
	datab => \inst1|data_counter\(2),
	datac => \inst1|data_counter\(0),
	datad => \inst1|data_counter\(1),
	combout => \inst1|done_flag~2_combout\);

-- Location: LCCOMB_X62_Y22_N30
\inst1|done_flag~4\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst1|done_flag~4_combout\ = (\inst1|wait_flag~regout\ & (\inst1|Add2~9_combout\ & (\inst1|first_clock~regout\ & \inst1|done_flag~2_combout\)))
...
PORT MAP (
	...
	datab => \inst1|Add2~9_combout\,
	datac => \inst1|first_clock~regout\,
	datad => \inst1|done_flag~2_combout\,
	combout => \inst1|done_flag~4_combout\);

-- Location: LCCOMB_X61_Y22_N24
\inst1|done_flag~3\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst1|done_flag~3_combout\ = (\inst1|done_flag~regout\ & (!\inst1|wait_flag~regout\)) # (!\inst1|done_flag~regout\ & (((\inst1|wait_conv~regout\ & \inst1|done_flag~4_combout\))))
...
PORT MAP (
	...
	datab => \inst1|wait_conv~regout\,
	datac => \inst1|done_flag~regout\,
	datad => \inst1|done_flag~4_combout\,
...
-- Equation(s):
-- \inst1|data_counter~4_combout\ = (\inst1|first_clock~regout\ & (\inst1|wait_conv~0_combout\ & (!\inst1|done_flag~regout\ & \inst1|wait_flag~regout\)))
...
-- Equation(s):
-- \inst1|Add2~8_combout\ = ((!\Reset_ADC_comm~combout\) # (!\inst1|data_counter\(0))) # (!\inst1|data_counter\(1))
...
\inst1|data_counter[3]~5\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst1|data_counter[3]~5_combout\ = ((!\inst1|done_flag~regout\ & ((!\inst1|wait_conv~0_combout\) # (!\inst1|first_clock~regout\)))) # (!\inst1|wait_flag~regout\)
...
PORT MAP (
	...
	datac => \inst1|done_flag~regout\,
	datad => \inst1|wait_flag~regout\,
	combout => \inst1|data_counter[3]~5_combout\);

-- Location: LCCOMB_X62_Y22_N2
\inst1|data_counter~10\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst1|data_counter~10_combout\ = (\inst1|data_counter~3_combout\ & ((\inst1|data_counter[3]~5_combout\) # ((\inst1|data_counter~4_combout\ & \inst1|Add2~8_combout\)))) # (!\inst1|data_counter~3_combout\ & (\inst1|data_counter~4_combout\ & 
-- (!\inst1|Add2~8_combout\)))
...
PORT MAP (
	...
	datad => \inst1|data_counter[3]~5_combout\,
...
-- Equation(s):
-- \inst1|data_counter~6_combout\ = (\inst1|data_counter[3]~5_combout\ & ((\inst1|data_counter~2_combout\) # ((\inst1|Add2~9_combout\ & \inst1|data_counter~4_combout\)))) # (!\inst1|data_counter[3]~5_combout\ & (\inst1|Add2~9_combout\ & 
-- (\inst1|data_counter~4_combout\)))
...
PORT MAP (
	dataa => \inst1|data_counter[3]~5_combout\,
	datab => \inst1|Add2~9_combout\,
	datac => \inst1|data_counter~4_combout\,
	datad => \inst1|data_counter~2_combout\,
	combout => \inst1|data_counter~6_combout\);

-- Location: LCFF_X62_Y22_N17
...
-- Equation(s):
-- \inst1|Decoder0~47_combout\ = (\inst1|Decoder0~45_combout\ & (!\inst1|data_counter\(3) & (\Reset_ADC_comm~combout\ & \inst1|data_counter\(1))))
...
PORT MAP (
	...
	datad => \inst1|Decoder0~47_combout\,
...
\inst7|flopped_ADC_DATA[9]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|flopped_ADC_DATA[9]~feeder_combout\ = \inst1|DATA_OUT\(9)
...
-- pragma translate_on
PORT MAP (
	datad => \inst1|DATA_OUT\(9),
	combout => \inst7|flopped_ADC_DATA[9]~feeder_combout\);

-- Location: LCCOMB_X61_Y22_N26
\inst1|DATA_READY~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst1|DATA_READY~0_combout\ = (\inst1|wait_conv~0_combout\ & (((\inst1|DATA_READY~regout\) # (\inst1|done_flag~4_combout\)))) # (!\inst1|wait_conv~0_combout\ & (!\inst1|wait_flag~regout\ & (\inst1|DATA_READY~regout\)))
...
PORT MAP (
	clk => \ALT_INV_Buffer_in~combout\,
	datain => \inst7|flopped_ADC_DATA[9]~feeder_combout\,
	ena => \inst7|flopped_ADC_DATA[7]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \inst7|Equal4~0_combout\ = ((\inst7|m_f_bit2~regout\) # ((\inst7|m_f_bit4~regout\) # (\inst7|m_f_bit3~regout\))) # (!\inst7|m_f_bit1~regout\)
...
-- pragma translate_on
PORT MAP (
	datab => \inst7|flopped_ADC_DATA\(9),
...
-- pragma translate_on
PORT MAP (
	dataa => \inst1|Decoder0~43_combout\,
	datab => \DOUT~combout\,
...
-- pragma translate_on
PORT MAP (
	datab => \inst7|flopped_ADC_DATA\(10),
	datac => \inst7|Equal4~0_combout\,
...
-- Equation(s):
-- \inst1|Decoder0~39_combout\ = ((!\inst1|data_counter\(1) & !\inst1|data_counter\(0))) # (!\Reset_ADC_comm~combout\)
...
-- Equation(s):
-- \inst1|Decoder0~44_combout\ = (\inst1|Decoder0~45_combout\ & (\inst1|Decoder0~39_combout\ & ((!\inst1|data_counter\(3)) # (!\Reset_ADC_comm~combout\))))
...
PORT MAP (
	...
	datad => \inst1|Decoder0~44_combout\,
...
PORT MAP (
	...
	datac => \inst7|Equal4~0_combout\,
	datad => \inst7|flopped_ADC_DATA\(11),
...
-- pragma translate_on
PORT MAP (
	datab => \In_switches~combout\(8),
	datac => \inst7|Equal4~0_combout\,
	datad => \inst7|flopped_ADC_DATA\(8),
...
PORT MAP (
	...
	datad => \inst7|communication:Respond_Data[8]~regout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \inst7|flopped_ADC_DATA\(1),
	datac => \inst7|Equal4~0_combout\,
...
-- Equation(s):
-- \inst1|Decoder0~46_combout\ = (\inst1|Decoder0~45_combout\ & (\inst1|data_counter\(3) & (\Reset_ADC_comm~combout\ & \inst1|data_counter\(1))))
...
PORT MAP (
	...
	datac => \inst7|Equal4~0_combout\,
	datad => \inst7|flopped_ADC_DATA\(0),
...
-- Equation(s):
-- \inst1|Decoder0~42_combout\ = (\inst1|Decoder0~45_combout\ & (\inst1|Decoder0~39_combout\ & (\Reset_ADC_comm~combout\ & \inst1|data_counter\(3))))
...
-- pragma translate_on
PORT MAP (
	datab => \inst7|flopped_ADC_DATA\(3),
	datac => \inst7|Equal4~0_combout\,
...
-- Equation(s):
-- \inst1|Decoder0~41_combout\ = (\inst1|Decoder0~45_combout\ & (\inst1|data_counter\(3) & (\Reset_ADC_comm~combout\ & \inst1|Decoder0~38_combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \inst1|Decoder0~41_combout\,
...
\inst7|flopped_ADC_DATA[2]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|flopped_ADC_DATA[2]~feeder_combout\ = \inst1|DATA_OUT\(2)
...
-- pragma translate_on
PORT MAP (
	datad => \inst1|DATA_OUT\(2),
	combout => \inst7|flopped_ADC_DATA[2]~feeder_combout\);

-- Location: LCFF_X64_Y22_N1
\inst7|flopped_ADC_DATA[2]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ALT_INV_Buffer_in~combout\,
	datain => \inst7|flopped_ADC_DATA[2]~feeder_combout\,
	ena => \inst7|flopped_ADC_DATA[7]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	datab => \inst7|flopped_ADC_DATA\(2),
	datac => \inst7|Equal4~0_combout\,
...
PORT MAP (
	dataa => \inst7|communication:respond_counter[1]~regout\,
	datab => \inst7|communication:Respond_Data[1]~regout\,
	datac => \inst7|communication:Respond_Data[0]~regout\,
...
-- Equation(s):
-- \inst1|Decoder0~37_combout\ = (\inst1|data_counter~3_combout\ & (!\inst1|data_counter~2_combout\ & (\inst1|wait_conv~0_combout\ & \inst1|Decoder0~36_combout\)))
...
PORT MAP (
	dataa => \inst1|data_counter~3_combout\,
	datab => \inst1|data_counter~2_combout\,
	datac => \inst1|wait_conv~0_combout\,
	datad => \inst1|Decoder0~36_combout\,
...
-- Equation(s):
-- \inst1|Decoder0~40_combout\ = (\Reset_ADC_comm~combout\ & (\inst1|Decoder0~37_combout\ & \inst1|data_counter\(1)))
...
PORT MAP (
	...
	datad => \inst1|Decoder0~40_combout\,
...
\inst7|flopped_ADC_DATA[4]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|flopped_ADC_DATA[4]~feeder_combout\ = \inst1|DATA_OUT\(4)
...
PORT MAP (
	...
	combout => \inst7|flopped_ADC_DATA[4]~feeder_combout\);

-- Location: LCFF_X64_Y22_N29
\inst7|flopped_ADC_DATA[4]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ALT_INV_Buffer_in~combout\,
	datain => \inst7|flopped_ADC_DATA[4]~feeder_combout\,
	ena => \inst7|flopped_ADC_DATA[7]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	...
	datad => \inst1|Decoder0~37_combout\,
...
\inst7|flopped_ADC_DATA[6]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|flopped_ADC_DATA[6]~feeder_combout\ = \inst1|DATA_OUT\(6)
...
-- pragma translate_on
PORT MAP (
	datad => \inst1|DATA_OUT\(6),
	combout => \inst7|flopped_ADC_DATA[6]~feeder_combout\);

-- Location: LCFF_X64_Y22_N31
\inst7|flopped_ADC_DATA[6]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ALT_INV_Buffer_in~combout\,
	datain => \inst7|flopped_ADC_DATA[6]~feeder_combout\,
	ena => \inst7|flopped_ADC_DATA[7]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	datab => \inst7|flopped_ADC_DATA\(6),
...
PORT MAP (
	clk => \ALT_INV_Buffer_in~combout\,
	sdata => \inst7|Respond_Data~1_combout\,
	sload => VCC,
	ena => \inst7|communication:Respond_Data[17]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \inst1|DATA_OUT[7]~2_combout\ = (\inst1|Decoder0~39_combout\ & ((\inst1|Decoder0~37_combout\ & (\DOUT~combout\)) # (!\inst1|Decoder0~37_combout\ & ((\inst1|DATA_OUT\(7)))))) # (!\inst1|Decoder0~39_combout\ & (((\inst1|DATA_OUT\(7)))))
...
\inst7|flopped_ADC_DATA[7]~feeder\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst7|flopped_ADC_DATA[7]~feeder_combout\ = \inst1|DATA_OUT\(7)
...
-- pragma translate_on
PORT MAP (
	datad => \inst1|DATA_OUT\(7),
	combout => \inst7|flopped_ADC_DATA[7]~feeder_combout\);

-- Location: LCFF_X64_Y22_N3
\inst7|flopped_ADC_DATA[7]\ : cycloneii_lcell_ff
PORT MAP (
	clk => \ALT_INV_Buffer_in~combout\,
	datain => \inst7|flopped_ADC_DATA[7]~feeder_combout\,
	ena => \inst7|flopped_ADC_DATA[7]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	dataa => \inst7|communication:respond_counter[1]~regout\,
	datab => \inst7|communication:respond_counter[0]~regout\,
	datac => \inst7|communication:Respond_Data[6]~regout\,
	datad => \inst7|communication:Respond_Data[7]~regout\,
...
PORT MAP (
	dataa => \inst7|communication:respond_counter[1]~regout\,
	datab => \inst7|communication:Respond_Data[5]~regout\,
	datac => \inst7|communication:Respond_Data[4]~regout\,
...
PORT MAP (
	...
	datab => \inst7|communication:respond_counter[2]~regout\,
	datac => \inst7|Selector30~2_combout\,
...
PORT MAP (
	...
	datab => \inst7|Selector30~4_combout\,
...
PORT MAP (
	clk => \ALT_INV_Buffer_in~combout\,
	sdata => \inst7|r_state.check_functioncode~regout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
