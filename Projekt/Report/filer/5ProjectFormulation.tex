...
This is only a short excerpt of the original project formulation, for the entire original project description see \ref{...}. \fxfatal{Reference til bilag eller cd hvor den originale beskrivelse kan findes.}
