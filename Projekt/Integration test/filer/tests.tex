...
\subsection{Reliability test case 1: Timed Transmissions and errors}
\textbf{Purpose:}\\
...
\textbf{Expected Result:}\\
With 10 messages each second for 60 minutes a total of 36000 messages are sent. 1\%\char24 ~of errors or 1 error per thousand transmission is expected.
