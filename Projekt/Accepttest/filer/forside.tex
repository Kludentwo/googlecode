...
\HRule \\[0.4cm]
{ \huge \bfseries Accept test}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
%----------------------------------------------------------------------------------------
...
\centering
    ...
    \hline
    Projecttitel: & \multicolumn{3}{|c|}{Charcot-Fod - Design og udvikling af temperatur-måle-device}                              \\ \hline
    Projectnr:   & 14030                                                       & Supervisor:             & PKI@iha.dk              \\ \hline
    Provider:    & Delta                                                       & Co-supervisor:          & \textit{None}           \\ \hline
