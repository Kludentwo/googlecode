...
\begin{table}[H]
	...
	\begin{tabular}{|p{3cm} | p{8cm}| }
		...
		P+ 				& The P+ input is the positive supply connection. \\ \hline
		P- 				& The P- input is the reference/ground supply connection. \\ \hline
		3.3V			& This is the 3.3V supply voltage to the internal circuitry on the CDU. \\ 	\hline
		Sensor Power	  & The power dictated by the formula previously defined in this subsection. \\ \hline
		GND				& Voltage reference ground. \\\hline 
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{3cm} | p{8cm}| }
		\hline
		Interface name: 	& Description \\ \hline
		Sensor Power	  & The Sensor power from the Power supply. \\ \hline
		GND				& Voltage reference ground. \\\hline 
		A Sensor com send	& Analog sensor communication to bus. \\\hline 
		A Sensor com receive	& Analog sensor communication from bus. \\\hline
		B+ 				& The B+ input is the positive bus supply connection. \\ \hline
		B- 				& The B- input is the negative bus supply connection. \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{3cm} | p{8cm}| }
		\hline
		Interface name: 	& Description \\ \hline
		Com power	  & The 3.3V power from the Power supply. \\ \hline
		GND				& Voltage reference ground. \\\hline 
		A Sensor com send	& Analog sensor communication to bus. \\\hline 
		A Sensor com receive	& Analog sensor communication from bus. \\\hline
		D Sensor com send	& Analog sensor communication from µ-Controller. \\\hline 
		A Sensor com receive	& Analog sensor communication to µ-Controller. \\\hline
	\end{tabular}
\end{table}
