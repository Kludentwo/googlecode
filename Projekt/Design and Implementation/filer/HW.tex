...
\subsubsection{Logic handler}
Below on figure ... a figure of the implementation of the logic handler. 


\textbf{Data acquisition interfacing:}\\
The data acquisition interfacing has a SPI implementation that fits the interface of the MAX1241 adc.

\textbf{Powerline communication:}\\
