...
\subsection{Sensor node schematic}
The CDU schematic is found on figure \ref{Schematic:CDUschem}.
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{billeder/CDU_schematic_rotated}
	\caption{CDU schematic revision 4}
	\label{Schematic:CDUschem}
\end{figure}

\subsection{Print layout}
Below is shown the current revision of the CDU print layout.\\
\begin{figure}[H]
	\centering
	\includegraphics[width=.85\textwidth]{billeder/CDUPCB}
\end{figure}
