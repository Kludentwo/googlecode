...
{ \huge \bfseries \textsc{Documentation}} % Document title
\HRule \\[1.5cm]
%----------------------------------------------------------------------------------------
...
\ \\
\fbox{
\parbox[c][5cm][t]{7cm}{This document is made in the bachelors project "Charcot foot prevention system". The project is provided by DELTA and adjusted by the group.\\
